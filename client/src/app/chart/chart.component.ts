...
@Component({
    ...
    template: `
    <ngx-charts-chart
      [attr.view]="[width, height]"
      [attr.showLegend]="false"
      [attr.animations]="animations"
      class="timeline-filter-bar-chart">
      <svg:g [attr.transform]="transform" class="chart">
        <svg:g ngx-charts-x-axis
          *ngIf="xAxis"
          [attr.xScale]="timeScale"
          [attr.dims]="dims"
  ...
  `,
    //styleUrls: ['@swimlane/ngx-charts/release/base-chart.component.scss'],
